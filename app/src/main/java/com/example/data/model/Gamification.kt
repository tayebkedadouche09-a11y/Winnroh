...
data class UserProfile(
    ...
    val username: String = "ahmed_explorer",
    val displayName: String = "Ahmed",
    val bio: String = "Living to explore great coffee, rooftop sunsets & retro arcade gems ☕🎮",
    val avatarUrl: String = "",
    val country: String = "Global Explorer",
    val city: String = "Algiers",
    val selectedInterests: List<String> = listOf("COFFEE", "GAMING", "FOOD", "NATURE", "NIGHTLIFE"),
    val typicalBudget: BudgetLevel = BudgetLevel.MODERATE,
    val xp: Int = 3840,
    val level: Int = 12,
    val levelTitle: String = "Traveler",
    val placesDiscoveredCount: Int = 47,
